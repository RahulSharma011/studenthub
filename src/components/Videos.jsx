  ...
  return (
    <Stack direction={['column', 'row']} h={'100vh'}>
      <VStack w={'full'}>
        ...
        <VStack alignItems={'flex-start'} pt={'1.5'} p={'8'} w={'full'}  h={'100px'} overflowY={'scroll'}>
          <Heading>Sample Video</Heading>
          <Text>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nulla
            asperiores repellendus magni quaerat earum reiciendis totam maxime
            atque sunt voluptatem.
          </Text>
        </VStack>
      </VStack>
      <VStack
